...
#define BL_HTTP_SERVER                       @"http://120.77.241.19:8080/lightwallet/server/process/"

#else //外网真实

#define BL_HTTP_SERVER                       @"https://lw.gdw.top:9527/server/process/"

#endif

#define Interface_Combine(url) [NSString stringWithFormat:@"%@%@", BL_HTTP_SERVER, url]
